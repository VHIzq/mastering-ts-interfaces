...
(() => {
  ...
  const joey = new Duelist('Joey', 'Wheeler', 'Red Eyes Dragon'); */
    class Duelist {
        constructor(firstName, lastName, _score, _secretCard, _hasMilleniumObject) {
            this.firstName = firstName;
            this.lastName = lastName;
            this._score = _score;
            this._secretCard = _secretCard;
            this._hasMilleniumObject = _hasMilleniumObject;
        }
        get fullName() {
